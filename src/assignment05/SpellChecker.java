...
public class SpellChecker {
  ...
  public void removeFromDictionary(String word) {
    ...
    dictionary.delete(toDelete, word);
  }
  ...
  public List<String> spellCheck(File documentFile) {
    ...
    for (int i = 0 ; i < wordsToCheck.size(); i ++){ //index through list

      if(!dictionary.contains(wordsToCheck.get(i))) { // if word is misspelled, add to new list
        misspelledWords.add(wordsToCheck.get(i));

      }
    }
    return misspelledWords; // return list of misspelled words
  }
