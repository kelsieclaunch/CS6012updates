...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    //check for an isbn that doesn't exist
    if(lib2.lookup(9791263782933L) != null){
      System.err.println("TEST FAILED: isbn lookup");
    }
    if(lib2.checkin(9791263782933L) != false){
      System.err.println("TEST FAILED: isbn checkin");
    }
