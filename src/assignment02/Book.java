 ...
 */
public class Book {
  //Book class contains member variables for isbn, author, and title
  ...
  public Book(long isbn, String author, String title) { //constructor
    this.isbn = isbn;
    this.author = author;
    this.title = title;
  }
  ...
  public boolean equals(Object other) {
    ...
    if (isbn == newBook.isbn && author == newBook.author && title == newBook.title){ //checking if the strings for isbn, author, and title are all equal
      return true;
    }
      return false;
  }
